...
while.cond:                                       ; preds = %land.rhs, %if.end.while.cond_crit_edge
...
if.end34.loopexit:                                ; preds = %land.rhs, %land.lhs.true10, %land.lhs.true5, %while.cond
...
while.body:                                       ; preds = %if.end9, %while.body.preheader
