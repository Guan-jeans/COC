...
while.cond:                                       ; preds = %if.end, %if.end21
  %s.addr.0 = phi i8* [ %incdec.ptr, %if.end21 ], [ %s, %if.end ]
  %i.0 = phi i32 [ %i.1, %if.end21 ], [ 0, %if.end ]
...
land.end:                                         ; preds = %land.rhs, %while.cond
  %1 = phi i1 [ false, %while.cond ], [ %cmp5, %land.rhs ]
  %2 = load i8, i8* %s.addr.0, align 1, !tbaa !12
...
land.lhs.true10:                                  ; preds = %while.body
  ...
  %3 = load i8, i8* %arrayidx11, align 1, !tbaa !12
  %cmp13 = icmp eq i8 %3, 37
...
land.lhs.true15:                                  ; preds = %land.lhs.true10
  ...
  %4 = load i8, i8* %arrayidx16, align 1, !tbaa !12
...
while.end:                                        ; preds = %land.end
  %cmp23 = icmp eq i8 %2, 0
  %add.ptr = getelementptr inbounds i8, i8* %s.addr.0, i32 2
  %spec.select37 = select i1 %cmp23, i8* %s.addr.0, i8* %add.ptr
  ret i8* %spec.select37
...
if.end:                                           ; preds = %entry
  ...
  br i1 %cmp1, label %while.cond, label %if.end34

while.cond:                                       ; preds = %if.end, %land.rhs
  %k.0 = phi i32 [ %add, %land.rhs ], [ 0, %if.end ]
  %arrayidx = getelementptr inbounds i8, i8* %s, i32 %k.0
  %0 = load i8, i8* %arrayidx, align 1, !tbaa !12
  %cmp3 = icmp eq i8 %0, 0
  br i1 %cmp3, label %if.end34, label %land.lhs.true5
...
land.lhs.true5:                                   ; preds = %while.cond
  ...
  %cmp8 = icmp eq i8 %1, 0
  br i1 %cmp8, label %if.end34, label %land.lhs.true10
...
land.lhs.true10:                                  ; preds = %land.lhs.true5
  ...
  br i1 %cmp14, label %if.end34, label %land.rhs
...
land.rhs:                                         ; preds = %land.lhs.true10
  ...
  br i1 %or.cond61, label %if.end34, label %while.cond

if.end34:                                         ; preds = %land.rhs, %land.lhs.true10, %land.lhs.true5, %while.cond, %if.end
  %k.1 = phi i32 [ %n, %if.end ], [ %k.0, %while.cond ], [ %k.0, %land.lhs.true5 ], [ %k.0, %land.lhs.true10 ], [ %k.0, %land.rhs ]
...
while.body:                                       ; preds = %if.end, %if.end9
  %line.034 = phi i8* [ %call12, %if.end9 ], [ %call, %if.end ]
  %i.033 = phi i32 [ %inc, %if.end9 ], [ 0, %if.end ]
...
while.end:                                        ; preds = %if.end9, %if.end
  %line.0.lcssa = phi i8* [ %call, %if.end ], [ %call12, %if.end9 ]
  %cmp1.lcssa = phi i1 [ %cmp131, %if.end ], [ %cmp1, %if.end9 ]
...
while.body:                                       ; preds = %if.end, %if.end9
  %line.035 = phi i8* [ %call12, %if.end9 ], [ %call, %if.end ]
  %i.034 = phi i32 [ %inc, %if.end9 ], [ 0, %if.end ]
...
while.end:                                        ; preds = %if.end9, %if.end
  %line.0.lcssa = phi i8* [ %call, %if.end ], [ %call12, %if.end9 ]
  %cmp1.lcssa = phi i1 [ %cmp132, %if.end ], [ %cmp1, %if.end9 ]
  br i1 %cmp1.lcssa, label %if.then15, label %if.end18
...
while.body:                                       ; preds = %if.end, %if.end8
  %line.034 = phi i8* [ %call11, %if.end8 ], [ %call, %if.end ]
  %i.033 = phi i32 [ %inc, %if.end8 ], [ 0, %if.end ]
  store i8* %line.034, i8** %endptr, align 4, !tbaa !13
  %call3 = call i32 @strtol(i8* nonnull %line.034, i8** nonnull %endptr, i32 10) #9
  %2 = load i8*, i8** %endptr, align 4, !tbaa !13
  %3 = load i8, i8* %2, align 1, !tbaa !12
...
while.end:                                        ; preds = %if.end8, %if.end
  %line.0.lcssa = phi i8* [ %call, %if.end ], [ %call11, %if.end8 ]
  %cmp1.lcssa = phi i1 [ %cmp131, %if.end ], [ %cmp1, %if.end8 ]
...
if.end3:                                          ; preds = %if.then2, %if.end
  ...
  br i1 %cmp431, label %while.body, label %do.body.preheader

do.body.preheader:                                ; preds = %while.cond, %if.end3
  br label %do.body

while.cond:                                       ; preds = %while.body
  %cmp4 = icmp sgt i32 %n.addr.0, %add
  br i1 %cmp4, label %while.body, label %do.body.preheader

while.body:                                       ; preds = %if.end3, %while.cond
  %written.032 = phi i32 [ %add, %while.cond ], [ 0, %if.end3 ]
...
for.body:                                         ; preds = %for.cond.preheader, %for.body
  %i.07 = phi i32 [ %inc, %for.body ], [ 0, %for.cond.preheader ]
...
while.body:                                       ; preds = %while.cond.preheader, %while.cond
  %written.03 = phi i32 [ %add, %while.cond ], [ 0, %while.cond.preheader ]
...
while.end:                                        ; preds = %while.cond, %while.cond.preheader
  %written.0.lcssa = phi i32 [ 0, %while.cond.preheader ], [ %add, %while.cond ]
